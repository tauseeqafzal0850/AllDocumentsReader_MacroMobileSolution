...
*/
            ...
            File file = createImageFile(getActivity());
    //            boolean isDirectoryCreated = file.getParentFile().mkdirs();
    //            Log.d("", "openCamera: isDirectoryCreated: " + isDirectoryCreated);
//        String authority =
//                getActivity().getPackageName() + getActivity().getString(R.string.image_picker_provider_authority_suffix);
        String authority =
                getActivity().getPackageName() + getActivity().getString(R.string.provider_authority_suffix);

            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                assert file != null;
                Uri tempFileUri = FileProvider.getUriForFile(getContext().getApplicationContext(),
//                        "com.scanlibrary.library.provider", // As defined in Manifest
...
//    }
    private  File createImageFile(Activity activity) {
        ...
        String dateTime = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date());
