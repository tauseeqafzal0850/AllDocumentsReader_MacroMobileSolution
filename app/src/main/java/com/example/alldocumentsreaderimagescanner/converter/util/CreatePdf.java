...
import static com.example.alldocumentsreaderimagescanner.converter.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static com.example.alldocumentsreaderimagescanner.converter.util.Constants.pdfExtension;
...
public class CreatePdf extends AsyncTask<String, String, String> {
    ...
    public CreatePdf(ImageToPDFOptions mImageToPDFOptions, String parentPath,
        ...
        this.mWatermarkAdded = mImageToPDFOptions.getMWatermarkAdded();
        this.mWatermark = mImageToPDFOptions.getMWatermark();
...
//            Log.v("Stage 4", "Document opened");
            ...
            for (int i = 0; i < mImagesUri.size(); i++) {
                int quality;
                quality = 30;
                if (StringUtils.Companion.getInstance().isNotEmpty(mQualityString)) {
                    quality = Integer.parseInt(mQualityString);
                }
//                Log.d("doInBackground", "doInBackground: "+mImagesUri.size());
//                Log.d("doInBackground", "doInBackground: "+mImagesUri.get(i));
