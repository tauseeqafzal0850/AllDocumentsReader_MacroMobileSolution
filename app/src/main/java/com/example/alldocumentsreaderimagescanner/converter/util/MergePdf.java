...
public class MergePdf extends AsyncTask<ArrayList<String>, Void, Void> {
    ...
    @Override
    protected Void doInBackground(ArrayList<String>... pdfpaths) {
        try {
            PdfReader pdfreader;
            ...
            document.open();
            int numOfPages;
            ArrayList<String> paths = pdfpaths[0];
            for (String pdfPath : paths) {
