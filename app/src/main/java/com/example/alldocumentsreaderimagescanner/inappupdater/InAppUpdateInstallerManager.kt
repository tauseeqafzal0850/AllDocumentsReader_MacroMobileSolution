package com.example.alldocumentsreaderimagescanner.inappupdater
...
class InAppUpdateInstallerManager(
    ...
    override fun startCheckUpdate() {
        ...
        appUpdateInfoTask.addOnSuccessListener { appUpdateInfo ->
            if ( (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE)/*&& ((appUpdateInfo.clientVersionStalenessDays() ?: -1) >= DAYS_FOR_FLEXIBLE_UPDATE)*/) {
                // Request the update.
                try {
