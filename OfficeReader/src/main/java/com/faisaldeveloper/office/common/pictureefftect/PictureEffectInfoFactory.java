 ...
 * 时间:              上午9:08:14
 */
package com.faisaldeveloper.office.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.faisaldeveloper.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
