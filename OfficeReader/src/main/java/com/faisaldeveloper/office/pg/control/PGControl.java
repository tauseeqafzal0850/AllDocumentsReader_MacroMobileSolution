...
import com.faisaldeveloper.office.pg.dialog.NotesDialog;
import com.faisaldeveloper.office.pg.model.PGModel;
import com.faisaldeveloper.office.system.AbstractControl;
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new NotesDialog(this, getMainFrame().getActivity(), null, vector,
