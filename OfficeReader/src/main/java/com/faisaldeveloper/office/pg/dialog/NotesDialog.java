 ...
 * 时间:               上午11:21:10
 */
package com.faisaldeveloper.office.pg.dialog;
...
import com.faisaldeveloper.office.system.beans.ADialog;
...
public class NotesDialog extends ADialog
{
    ...
    {
        super(control, context, action, model, dialogID, "pg_toolsbar_note");
        init(context);
    }
