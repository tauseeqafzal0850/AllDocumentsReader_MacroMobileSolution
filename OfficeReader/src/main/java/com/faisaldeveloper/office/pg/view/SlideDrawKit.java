 ...
 * 时间:              下午4:04:42
 */
package com.faisaldeveloper.office.pg.view;

import java.util.Map;

import com.faisaldeveloper.office.common.BackgroundDrawer;
import com.faisaldeveloper.office.common.PaintKit;
import com.faisaldeveloper.office.common.autoshape.AutoShapeKit;
import com.faisaldeveloper.office.common.borders.Line;
import com.faisaldeveloper.office.common.picture.PictureKit;
...
import com.faisaldeveloper.office.pg.control.PGEditor;
import com.faisaldeveloper.office.pg.control.Presentation;
...
//            (int)(rect.x * zoom), (int)(rect.y * zoom), zoom, (int)(rect.width * zoom), (int)(rect.height * zoom), null, chart.getAnimation());
    ...
    private void drawTable(Canvas canvas, PGModel pgModel, PGEditor editor, int slideNo, TableShape table, float zoom, Map<Integer, Map<Integer, IAnimation>> shapeVisible)
    {
        ...
        {
            int LAYERS_FLAGS = MATRIX_SAVE_FLAG |
                CLIP_SAVE_FLAG
