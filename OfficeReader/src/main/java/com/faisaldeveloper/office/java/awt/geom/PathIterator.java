...
package com.faisaldeveloper.office.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link com.faisaldeveloper.office.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link com.faisaldeveloper.office.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see com.faisaldeveloper.office.fc.hwpf.usermodel.Shape
 * @see com.faisaldeveloper.office.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
