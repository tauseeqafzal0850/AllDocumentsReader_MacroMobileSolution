...
package com.faisaldeveloper.office.system.dialog;
...
public class ColorPickerDialog extends Dialog
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final ColorPickerView colorView = view.findViewById(R.id.colorPickerView);
        final SeekBar strokeBar = view.findViewById(R.id.strokeBar);
        final SeekBar alphaBar = view.findViewById(R.id.alphaBar);
