 ...
 * 时间:              下午3:10:35
 */
package com.faisaldeveloper.office.fc.xls.Reader.shared;
...
import com.faisaldeveloper.office.ss.model.sheetProperty.Palette;
import com.faisaldeveloper.office.ss.model.style.BorderStyle;
import com.faisaldeveloper.office.ss.model.style.BuiltinFormats;
import com.faisaldeveloper.office.ss.model.style.CellBorder;
import com.faisaldeveloper.office.ss.model.style.CellStyle;
import com.faisaldeveloper.office.ss.model.style.NumberFormat;
import com.faisaldeveloper.office.ss.model.table.TableFormatManager;
import com.faisaldeveloper.office.ss.util.ColorUtil;
...
public class StyleReader {
    ...
    private void processCellStyleAlignment(CellStyle cellStyle, Element alignment) {
        ...
        if (alignment.attributeValue("wrapText") != null) {
            String str = alignment.attributeValue("wrapText");
            cellStyle.setWrapText(str.equals("true"));
    ...
    class StyleSaxHandler implements ElementHandler {
        ...
        public void onEnd(ElementPath elementPath) {
            ...
            if (name.equals("numFmt")) {
                ...
                //com.faisaldeveloper.office.fc.dom4j.tree.DefaultElement@1b5b127 [Element: <xf uri: http://schemas.openxmlformats.org/spreadsheetml/2006/main attributes: [com.faisaldeveloper.office.fc.dom4j.tree.DefaultAttribute@1807fd4 [Attribute: name numFmtId value "0"], com.faisaldeveloper.office.fc.dom4j.tree.DefaultAttribute@ca1357d [Attribute: name fontId value "0"], com.faisaldeveloper.office.fc.dom4j.tree.DefaultAttribute@a9e0c72 [Attribute: name fillId value "0"], com.faisaldeveloper.office.fc.dom4j.tree.DefaultAttribute@f4238c3 [Attribute: name borderId value "0"], com.faisaldeveloper.office.fc.dom4j.tree.DefaultAttribute@64fc540 [Attribute: name xfId value "0"]]/>]
