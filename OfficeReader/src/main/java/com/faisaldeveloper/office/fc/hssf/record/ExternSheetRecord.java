...
public class ExternSheetRecord extends StandardRecord {
	...
	private static final class RefSubRecord {
		...
		private final int _firstSheetIndex; // may be -1 (0xFFFF)
		private final int _lastSheetIndex;  // may be -1 (0xFFFF)
	...
	/**
     * Add a zero-based reference to a {@link com.faisaldeveloper.office.fc.hssf.record.SupBookRecord}.
     * <p>
     ...
     *    see {@link com.faisaldeveloper.office.fc.hssf.record.SupBookRecord#getSheetNames()}.
     ...
     *    {@link com.faisaldeveloper.office.fc.hssf.record.BoundSheetRecord} record in the workbook stream that specifies
