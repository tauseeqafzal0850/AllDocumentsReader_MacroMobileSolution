 ...
 * 时间:              下午6:08:08
 */
package com.faisaldeveloper.office.fc.xls.Reader;
...
import com.faisaldeveloper.office.fc.xls.Reader.drawing.DrawingReader;
import com.faisaldeveloper.office.fc.xls.Reader.table.TableReader;
...
import com.faisaldeveloper.office.ss.model.sheetProperty.ColumnInfo;
...
public class SheetReader
{
    ...
    private void setColumnProperty(Element col)
    {
        ...
        if(col.attributeValue("hidden") != null)
        {
           // hidden = (Integer.parseInt(col.attributeValue("hidden")) != 0);
            hidden = col.attributeValue("hidden").equals("true");
        }
        else
        {
            hidden = false;
    ...
    {        
        ...
        {
           // hidden = (Integer.parseInt(rowElement.attributeValue("hidden")) != 0);
            hidden = rowElement.attributeValue("hidden").equals("true");
        }
