 ...
 * 时间:               下午1:41:20
 */
package com.faisaldeveloper.office.fc;
...
import com.faisaldeveloper.office.fc.ddf.AbstractEscherOptRecord;
import com.faisaldeveloper.office.fc.ddf.EscherArrayProperty;
import com.faisaldeveloper.office.fc.ddf.EscherComplexProperty;
...
import com.faisaldeveloper.office.fc.ddf.EscherProperty;
...
import com.faisaldeveloper.office.fc.ddf.EscherTertiaryOptRecord;
...
import com.faisaldeveloper.office.fc.util.StringUtil;
...
public class ShapeKit
{
    ...
    public static ArrowPathAndTail getStartArrowPathAndTail(EscherContainerRecord _escherContainer, Rectangle rect)
    {
        ...
        if (prop != null && prop.getPropertyValue() > 0)
        {
            ...
            int lineWidth = Math.round(getLineWidth(_escherContainer) * MainConstant.POINT_TO_PIXEL);
