...
public final class FontTable
{
    ...
    private final short _extraDataSz;// size in bytes of the extra data

    // added extra facilitator members
    private final int lcbSttbfffn;// count of bytes in sttbfffn
    private final int fcSttbfffn;// table stream offset for sttbfffn
