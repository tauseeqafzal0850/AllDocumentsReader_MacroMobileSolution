...
import com.faisaldeveloper.office.common.bookmark.Bookmark;
import com.faisaldeveloper.office.common.borders.Border;
import com.faisaldeveloper.office.common.borders.Borders;
import com.faisaldeveloper.office.common.borders.Line;
import com.faisaldeveloper.office.common.bulletnumber.ListData;
import com.faisaldeveloper.office.common.bulletnumber.ListLevel;
import com.faisaldeveloper.office.common.hyperlink.Hyperlink;
import com.faisaldeveloper.office.common.picture.Picture;
...
import com.faisaldeveloper.office.common.shape.WPAbstractShape;
import com.faisaldeveloper.office.common.shape.WPAutoShape;
import com.faisaldeveloper.office.common.shape.WPGroupShape;
import com.faisaldeveloper.office.common.shape.WPPictureShape;
...
import com.faisaldeveloper.office.fc.ddf.EscherContainerRecord;
import com.faisaldeveloper.office.fc.ddf.EscherOptRecord;
import com.faisaldeveloper.office.fc.ddf.EscherProperties;
import com.faisaldeveloper.office.fc.ddf.EscherSimpleProperty;
import com.faisaldeveloper.office.fc.ddf.EscherTextboxRecord;
import com.faisaldeveloper.office.fc.hwpf.HWPFDocument;
import com.faisaldeveloper.office.fc.hwpf.model.FieldsDocumentPart;
import com.faisaldeveloper.office.fc.hwpf.model.ListFormatOverride;
import com.faisaldeveloper.office.fc.hwpf.model.ListTables;
import com.faisaldeveloper.office.fc.hwpf.model.POIListData;
import com.faisaldeveloper.office.fc.hwpf.model.POIListLevel;
import com.faisaldeveloper.office.fc.hwpf.model.PicturesTable;
import com.faisaldeveloper.office.fc.hwpf.usermodel.Bookmarks;
import com.faisaldeveloper.office.fc.hwpf.usermodel.BorderCode;
import com.faisaldeveloper.office.fc.hwpf.usermodel.CharacterRun;
import com.faisaldeveloper.office.fc.hwpf.usermodel.Field;
import com.faisaldeveloper.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.faisaldeveloper.office.fc.hwpf.usermodel.HWPFShape;
import com.faisaldeveloper.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.faisaldeveloper.office.fc.hwpf.usermodel.HeaderStories;
import com.faisaldeveloper.office.fc.hwpf.usermodel.InlineWordArt;
import com.faisaldeveloper.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.faisaldeveloper.office.fc.hwpf.usermodel.OfficeDrawing;
import com.faisaldeveloper.office.fc.hwpf.usermodel.OfficeDrawings;
import com.faisaldeveloper.office.fc.hwpf.usermodel.POIBookmark;
import com.faisaldeveloper.office.fc.hwpf.usermodel.Paragraph;
import com.faisaldeveloper.office.fc.hwpf.usermodel.PictureType;
import com.faisaldeveloper.office.fc.hwpf.usermodel.Range;
import com.faisaldeveloper.office.fc.hwpf.usermodel.Section;
import com.faisaldeveloper.office.fc.hwpf.usermodel.Table;
import com.faisaldeveloper.office.fc.hwpf.usermodel.TableCell;
import com.faisaldeveloper.office.fc.hwpf.usermodel.TableRow;
import com.faisaldeveloper.office.fc.util.LittleEndian;
import com.faisaldeveloper.office.java.awt.Rectangle;
import com.faisaldeveloper.office.java.util.Arrays;
...
import com.faisaldeveloper.office.simpletext.view.PageAttr;
import com.faisaldeveloper.office.ss.util.ModelUtil;
import com.faisaldeveloper.office.system.AbstractReader;
import com.faisaldeveloper.office.system.IControl;
import com.faisaldeveloper.office.wp.model.CellElement;
import com.faisaldeveloper.office.wp.model.HFElement;
import com.faisaldeveloper.office.wp.model.RowElement;
import com.faisaldeveloper.office.wp.model.TableElement;
import com.faisaldeveloper.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.faisaldeveloper.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.faisaldeveloper.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.faisaldeveloper.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.faisaldeveloper.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
