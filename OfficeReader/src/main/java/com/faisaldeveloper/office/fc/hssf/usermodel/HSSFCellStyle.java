...
import com.faisaldeveloper.office.fc.ss.usermodel.IFont;
 ...
 * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.faisaldeveloper.office.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.faisaldeveloper.office.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.faisaldeveloper.office.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.faisaldeveloper.office.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.faisaldeveloper.office.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.faisaldeveloper.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.faisaldeveloper.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.faisaldeveloper.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.faisaldeveloper.office.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.faisaldeveloper.office.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
