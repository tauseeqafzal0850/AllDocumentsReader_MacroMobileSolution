 ...
 * 时间:               下午4:23:51
 */
package com.faisaldeveloper.office.fc.ppt;
...
import com.faisaldeveloper.office.common.PaintKit;
import com.faisaldeveloper.office.common.autoshape.ExtendPath;
import com.faisaldeveloper.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.faisaldeveloper.office.common.bg.BackgroundAndFill;
import com.faisaldeveloper.office.common.bg.Gradient;
import com.faisaldeveloper.office.common.bg.LinearGradientShader;
import com.faisaldeveloper.office.common.bg.RadialGradientShader;
import com.faisaldeveloper.office.common.bg.TileShader;
import com.faisaldeveloper.office.common.hyperlink.Hyperlink;
import com.faisaldeveloper.office.common.pictureefftect.PictureEffectInfoFactory;
import com.faisaldeveloper.office.common.shape.AbstractShape;
import com.faisaldeveloper.office.common.shape.ArbitraryPolygonShape;
import com.faisaldeveloper.office.common.shape.Arrow;
import com.faisaldeveloper.office.common.shape.AutoShape;
import com.faisaldeveloper.office.common.shape.GroupShape;
import com.faisaldeveloper.office.common.shape.IShape;
import com.faisaldeveloper.office.common.shape.LineShape;
import com.faisaldeveloper.office.common.shape.PictureShape;
import com.faisaldeveloper.office.common.shape.ShapeTypes;
import com.faisaldeveloper.office.common.shape.TableCell;
import com.faisaldeveloper.office.common.shape.TableShape;
import com.faisaldeveloper.office.common.shape.TextBox;
import com.faisaldeveloper.office.constant.AutoShapeConstant;
import com.faisaldeveloper.office.constant.EventConstant;
import com.faisaldeveloper.office.constant.MainConstant;
import com.faisaldeveloper.office.constant.wp.WPAttrConstant;
import com.faisaldeveloper.office.constant.wp.WPModelConstant;
import com.faisaldeveloper.office.fc.FCKit;
import com.faisaldeveloper.office.fc.ShapeKit;
import com.faisaldeveloper.office.fc.hslf.HSLFSlideShow;
import com.faisaldeveloper.office.fc.hslf.model.Fill;
import com.faisaldeveloper.office.fc.hslf.model.HeadersFooters;
import com.faisaldeveloper.office.fc.hslf.model.Line;
import com.faisaldeveloper.office.fc.hslf.model.MasterSheet;
import com.faisaldeveloper.office.fc.hslf.model.Notes;
import com.faisaldeveloper.office.fc.hslf.model.Shape;
import com.faisaldeveloper.office.fc.hslf.model.ShapeGroup;
import com.faisaldeveloper.office.fc.hslf.model.Sheet;
import com.faisaldeveloper.office.fc.hslf.model.SimpleShape;
import com.faisaldeveloper.office.fc.hslf.model.Slide;
import com.faisaldeveloper.office.fc.hslf.model.SlideMaster;
import com.faisaldeveloper.office.fc.hslf.model.TextShape;
import com.faisaldeveloper.office.fc.hslf.model.TitleMaster;
import com.faisaldeveloper.office.fc.hslf.record.BinaryTagDataBlob;
import com.faisaldeveloper.office.fc.hslf.record.ClientVisualElementContainer;
import com.faisaldeveloper.office.fc.hslf.record.DocumentAtom;
import com.faisaldeveloper.office.fc.hslf.record.OEPlaceholderAtom;
import com.faisaldeveloper.office.fc.hslf.record.PositionDependentRecordContainer;
import com.faisaldeveloper.office.fc.hslf.record.Record;
import com.faisaldeveloper.office.fc.hslf.record.SlideAtom;
import com.faisaldeveloper.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.faisaldeveloper.office.fc.hslf.record.SlideProgTagsContainer;
import com.faisaldeveloper.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.faisaldeveloper.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeNodeContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.faisaldeveloper.office.fc.hslf.record.TimeVariant;
import com.faisaldeveloper.office.fc.hslf.record.VisualShapeAtom;
import com.faisaldeveloper.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.faisaldeveloper.office.fc.hslf.usermodel.PictureData;
import com.faisaldeveloper.office.fc.hslf.usermodel.RichTextRun;
import com.faisaldeveloper.office.fc.hslf.usermodel.SlideShow;
import com.faisaldeveloper.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.faisaldeveloper.office.fc.ss.usermodel.Textbox;
import com.faisaldeveloper.office.java.awt.Dimension;
import com.faisaldeveloper.office.java.awt.Rectangle;
import com.faisaldeveloper.office.java.awt.Rectanglef;
import com.faisaldeveloper.office.java.awt.geom.Rectangle2D;
import com.faisaldeveloper.office.pg.animate.ShapeAnimation;
import com.faisaldeveloper.office.pg.model.PGModel;
import com.faisaldeveloper.office.pg.model.PGNotes;
import com.faisaldeveloper.office.pg.model.PGSlide;
import com.faisaldeveloper.office.simpletext.font.FontTypefaceManage;
import com.faisaldeveloper.office.simpletext.model.AttrManage;
import com.faisaldeveloper.office.simpletext.model.IAttributeSet;
import com.faisaldeveloper.office.simpletext.model.LeafElement;
import com.faisaldeveloper.office.simpletext.model.ParagraphElement;
import com.faisaldeveloper.office.simpletext.model.SectionElement;
import com.faisaldeveloper.office.ss.util.format.NumericFormatter;
import com.faisaldeveloper.office.system.AbstractReader;
import com.faisaldeveloper.office.system.BackReaderThread;
...
{   
    ...
    private com.faisaldeveloper.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.faisaldeveloper.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.faisaldeveloper.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
        	 int lineWidth = (int)Math.round(shape.getLineWidth() * MainConstant.POINT_TO_PIXEL);
             boolean dash = shape.getLineDashing() > AutoShapeConstant.LINESTYLE_SOLID;
             com.faisaldeveloper.office.java.awt.Color color = shape.getLineColor();
             
             if(color != null)
             {
            	 line = new com.faisaldeveloper.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.faisaldeveloper.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.faisaldeveloper.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.faisaldeveloper.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.faisaldeveloper.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.faisaldeveloper.office.fc.hslf.model.Freeform
            || shape instanceof com.faisaldeveloper.office.fc.hslf.model.AutoShape
            || shape instanceof com.faisaldeveloper.office.fc.hslf.model.TextBox
            || shape instanceof com.faisaldeveloper.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.faisaldeveloper.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.faisaldeveloper.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.faisaldeveloper.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.faisaldeveloper.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.faisaldeveloper.office.fc.hslf.model.AutoShape
                    || shape instanceof com.faisaldeveloper.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.faisaldeveloper.office.fc.hslf.model.Picture)
            {   
                com.faisaldeveloper.office.fc.hslf.model.Picture poiPic = (com.faisaldeveloper.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.faisaldeveloper.office.fc.hslf.model.Table)
        {
            com.faisaldeveloper.office.fc.hslf.model.Table poiTable = (com.faisaldeveloper.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.faisaldeveloper.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.faisaldeveloper.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.faisaldeveloper.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.faisaldeveloper.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.faisaldeveloper.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.faisaldeveloper.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.faisaldeveloper.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.faisaldeveloper.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.faisaldeveloper.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
