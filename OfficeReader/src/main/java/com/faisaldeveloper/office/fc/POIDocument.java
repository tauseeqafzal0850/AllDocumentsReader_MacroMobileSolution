...
import com.faisaldeveloper.office.fc.hpsf.DocumentSummaryInformation;
import com.faisaldeveloper.office.fc.hpsf.MutablePropertySet;
import com.faisaldeveloper.office.fc.hpsf.PropertySet;
import com.faisaldeveloper.office.fc.hpsf.PropertySetFactory;
import com.faisaldeveloper.office.fc.hpsf.SummaryInformation;
...
import com.faisaldeveloper.office.fc.poifs.filesystem.DocumentInputStream;
import com.faisaldeveloper.office.fc.poifs.filesystem.Entry;
import com.faisaldeveloper.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.faisaldeveloper.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.faisaldeveloper.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.faisaldeveloper.office.fc.hpsf.WritingNotSupportedException wnse)
        {
